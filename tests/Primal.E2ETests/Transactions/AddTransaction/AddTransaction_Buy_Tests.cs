...
public sealed class AddTransaction_Buy_Tests
{
	[Test]
	public async Task Returns_201_And_GET_Returns_Created_Transaction()
	{
		...
		var transactionId = await TestDataSeeder.SeedBuyTransactionAsync(
			client, assetItemId, "2026-01-15", "Buy Mutual Fund Units", 10.5m, 150.25m);
